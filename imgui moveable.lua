...
function main:Begin(PROPS) 
    ...
    UserInputService.InputChanged:Connect(function(input)
        if selected and input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch then
            ResizeWindow()
        end
    end)
    ...
    topPanel.InputChanged:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseMovement Enum.UserInputType.Touch then
            dragInput = input
        end
    end)
