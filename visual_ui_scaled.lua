        ...
        task.spawn(function()
            ...
            if not CoreGui:FindFirstChild('Visual UI Library | .gg/puxxCphTnK | Notifications') then
                ...
                Utility:Create('Frame', {
                    ...
                    BorderSizePixel = 0,
                    Position = UDim2.new(1,  300, 0.700, -21.000),
                    Size = UDim2.new(0,  300, 0.000, 35.000),
                    ...
                    Utility:Create('TextLabel', {
                        ...
                        Position = UDim2.new(0,  0, 0.000, -0.700),
                        Size = UDim2.new(0,  300, 0.000, 21.000),
                    ...
                    Utility:Create('TextLabel', {
                        ...
                        BackgroundTransparency = 1,
                        Position = UDim2.new(0,  0, 0.000, 17.500),
                        Size = UDim2.new(0,  300, 0.000, 21.000),
                        Font = Enum.Font.Gotham,
                        Text = Text,
                        TextWrapped = true,
                ...
                if Amount > 1 then
                    ...
                    Utility:Tween(Holder, {Position = UDim2.new(1,  -30, 0.700, -21.000)}, 0.5)
                end
    ...
    function Library:CreatePrompt(Type, Title, Text, ...)
        ...
        if Type == 'Text' then
            ...
            Utility:Create('Frame', {
                ...
                Position = UDim2.new(0.5,  0, 0.350, 0.000),
                BorderSizePixel = 0,
                ZIndex = 101,
                BackgroundTransparency = NotificationTransparency,
                Size = UDim2.new(0,  0, 0.000, 0.000)
            }, {
                Utility:Create('UICorner', {
                ...
                Utility:Create('TextLabel', {
                    ...
                    Position = UDim2.new(0.5,  0, 0.000, 3.500),
                    Size = UDim2.new(0,  0, 0.000, 14.000),
                    Font = Enum.Font.Gotham,
                    Text = Title,
                    TextColor3 = Theme.PrimaryTextColor,
                    TextSize = 20,
                ...
                Utility:Create('TextLabel', {
                    ...
                    TextWrapped = true,
                    AnchorPoint = Vector2.new(0.5, 0),
                    Position = UDim2.new(0.5,  0, 0.000, 18.200),
                    Size = UDim2.new(0,  280, 0.000, 53.900),
                    Font = Enum.Font.Gotham,
                    Text = Text,
                    TextColor3 = Theme.SecondaryTextColor,
                    TextSize = 15,
                ...
                Utility:Create('TextButton', {
                    ...
                    TextColor3 = Theme.SecondaryTextColor,
                    TextXAlignment = Enum.TextXAlignment.Center,
                    Position = UDim2.new(0,  10, 0.000, 77.000),
                    Size = UDim2.new(0,  280, 0.000, 21.000),
                    BorderSizePixel = 0,
                    TextSize = 15,
                    ZIndex = 103,
                    Visible = true,
            ...
            Utility:Tween(PromptFrame, {Size = UDim2.new(0,  300, 0.000, 105.000)}, 0.25)
            ...
            Button.MouseButton1Down:Connect(function()
                ...
                Utility:Tween(PromptFrame, {Size = UDim2.new(0,  0, 0.000, 0.000)}, 0.25)
        ...
        elseif Type == 'TwoButton' then
            ...
            Utility:Create('Frame', {
                ...
                Utility:Create('TextButton', {
                    ...
                    TextXAlignment = Enum.TextXAlignment.Center,
                    Position = UDim2.new(0,  10, 0.000, 77.000),
                    Size = UDim2.new(0,  135, 0.000, 21.000),
                    BorderSizePixel = 0,
                    TextSize = 15,
                    ZIndex = 103,
                    Visible = true,
                ...
                Utility:Create('TextButton', {
                    ...
                    TextColor3 = Theme.SecondaryTextColor,
                    TextXAlignment = Enum.TextXAlignment.Center,
                    Position = UDim2.new(0,  155, 0.000, 77.000),
                    Size = UDim2.new(0,  135, 0.000, 21.000),
                    BorderSizePixel = 0,
                    TextSize = 15,
                    ZIndex = 103,
...
function Library:CreateWindow(HubName, GameName, IntroText, IntroIcon, ImprovePerformance, ConfigFolder, Theme)
    ...
    local Container = Utility:Create('ScreenGui', {
        ...
        Utility:Create('Frame', {
            ...
            BorderSizePixel = 0,
            BackgroundTransparency = 1,
            Position = UDim2.new(0,  595, 0.000, 105.000),
            Size = UDim2.new(0,  0, 0.000, 0.000)
        }, {
            Utility:Create('UICorner', {
                CornerRadius = UDim.new(0, 5),
            ...
            Utility:Create('TextLabel', {
                ...
                TextTransparency = 1,
                AnchorPoint = Vector2.new(0.5, 0.5),
                Position = UDim2.new(0.5,  0, 0.350, -28.000),
                BorderSizePixel = 0,
                Size = UDim2.new(0,  170, 0.000, 14.000),
                Font = Enum.Font.Gotham,
                Text = IntroText,
                TextColor3 = Theme.PrimaryTextColor,
                TextSize = 18,
            ...
            Utility:Create('ImageLabel', {
                ...
                BorderSizePixel = 0,
                AnchorPoint = Vector2.new(0.5, 0.5),
                Position = UDim2.new(0.5,  0, 0.350, 14.000),
                ZIndex = 3,
                Size = UDim2.new(0,  100, 0.000, 70.000),
                Image = IntroIcon,
    ...
    Utility:Tween(Main, {Size = UDim2.new(0,  600, 0.000, 0.000)}, 0.25)
    task.wait(0.5)
    Utility:Tween(Main, {Size = UDim2.new(0,  600, 0.000, 262.500)}, 0.25)
    task.wait(0.5)
    ...
    Utility:Create('Frame', {
        ...
        Parent = Main,
        BorderSizePixel = 0,
        Size = UDim2.new(0,  600, 0.000, 262.500),
        ZIndex = 100,
        Visible = true,
        BackgroundTransparency = 1,
        BackgroundColor3 = Theme.BackgroundColor
    ...
    Utility:Create('Frame', {
        Name = 'Filler1',
        Position = UDim2.new(0,  170, 0.000, 0.000),
        Parent = Main,
        BorderSizePixel = 0,
        Size = UDim2.new(0,  429, 0.000, 6.300),
        ZIndex = 1,
        BackgroundColor3 = Theme.BackgroundColor
    }, {
        Utility:Create('UICorner', {
    ...
    Utility:Create('Frame', {
        Name = 'Filler2',
        Parent = Main,
        Position = UDim2.new(0,  170, 0.000, 254.800),
        BorderSizePixel = 0,
        Size = UDim2.new(0,  429, 0.000, 7.700),
        ZIndex = 1,
        BackgroundColor3 = Theme.BackgroundColor
    }, {
        Utility:Create('UICorner', {
    ...
    Utility:Create('Frame', {
        ...
        Parent = Main,
        BorderSizePixel = 0,
        Size = UDim2.new(0,  170, 0.000, 262.500)
    }, {
        Utility:Create('UICorner', {
            CornerRadius = UDim.new(0, 5),
            Name = 'SidebarCorner'
        ...
        Utility:Create('Frame', {
            Name = 'NamesBehind',
            Position = UDim2.new(0,  0, 0.000, 0.000),
            BorderSizePixel = 0,
            Size = UDim2.new(0,  169, 0.000, 38.500),
            ZIndex = 1,
            BackgroundColor3 = Theme.SidebarColor
        }, {
            Utility:Create('UICorner', {
        ...
        Utility:Create('Frame', {
            Name = 'Filler3',
            Position = UDim2.new(0,  0, 0.000, 257.600),
            BorderSizePixel = 0,
            Size = UDim2.new(0,  170, 0.000, 4.900),
            ZIndex = 1,
            BackgroundColor3 = Theme.SidebarColor
        }, {
            Utility:Create('UICorner', {
        ...
        Utility:Create('TextLabel', {
            ...
            BackgroundColor3 = Theme.SidebarColor,
            BackgroundTransparency = 1,
            Position = UDim2.new(0,  0, 0.000, 4.200),
            BorderSizePixel = 0,
            Size = UDim2.new(0,  170, 0.000, 14.000),
            Font = Enum.Font.Gotham,
            Text = HubName,
        ...
        Utility:Create('TextLabel', {
            ...
            BackgroundColor3 = Theme.SidebarColor,
            BackgroundTransparency = 1,
            Position = UDim2.new(0,  0, 0.000, 16.800),
            BorderSizePixel = 0,
            Size = UDim2.new(0,  170, 0.000, 14.000),
            Font = Enum.Font.Gotham,
            Text = GameName,
        ...
        Utility:Create('Frame', {
            ...
            BorderSizePixel = 0,
            Position = UDim2.new(0,  170, 0.000, 0.000),
            Size = UDim2.new(0,  1, 0.000, 262.500)
        }),
        Utility:Create('Frame', {
            Name = 'SidebarLine2',
            BackgroundColor3 = Theme.UIStrokeColor,
            BorderSizePixel = 0,
            Position = UDim2.new(0,  0, 0.000, 33.600),
            Size = UDim2.new(0,  170, 0.000, 0.700)
        }),
        Utility:Create('ScrollingFrame', {
            ...
            BackgroundColor3 = Theme.SidebarColor,
            BorderSizePixel = 0,
            Position = UDim2.new(0,  0, 0.000, 38.500),
            Size = UDim2.new(0,  170, 0.000, 219.100),
    ...
    Utility:Create('Frame', {
        ...
        Parent = Main,
        BorderSizePixel = 0,
        Position = UDim2.new(0,  171, 0.000, 6.300),
        Size = UDim2.new(0,  429, 0.000, 248.500)
    }, {
    ...
    function Tabs:CreateTab(TabName, DefaultVisibility, Icon, RectOffset, RectSize)
        ...
        Utility:Create('ScrollingFrame', {
            ...
            BackgroundColor3 = Theme.BackgroundColor,
            BackgroundTransparency = 1,
            Size = UDim2.new(0,  428, 0.000, 255.500),
            BorderSizePixel = 0,
        ...
        Utility:Create('Frame', {
            ...
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
            Size = UDim2.new(0,  170, 0.000, 21.000)
        }, {
            Utility:Create('TextButton', {
                Name = TabName..'Button',
                BackgroundColor3 = Theme.SidebarColor,
            ...
            Utility:Create('ImageLabel', {
                ...
                BackgroundTransparency = 1,
                BorderSizePixel = 0,
                Position = UDim2.new(0,  10, 0.000, 3.500),
                Size = UDim2.new(0,  20, 0.000, 14.000),
                Image = Icon,
            ...
            Utility:Create('TextLabel', {
                ...
                BackgroundTransparency = 1,
                BorderSizePixel = 0,
                Position = UDim2.new(0,  30, 0.000, 2.100),
                Size = UDim2.new(0,  140, 0.000, 16.800),
                Font = Enum.Font.Gotham,
                Text = TabName,
                TextColor3 = Theme.PrimaryTextColor,
                TextSize = 16,
        ...
        function Sections:CreateSection(Name)
            ...
            Utility:Create('Frame', {
                ...
                BackgroundColor3 = Theme.BackgroundColor,
                BorderSizePixel = 0,
                Size = UDim2.new(0,  410, 0.000, 21.000),
            }, {
                Utility:Create('TextLabel', {
            ...
            function Elements:CreateParagraph(Title, Paragraph)
                ...
                Utility:Create('Frame', {
                    ...
                    Parent = Section,
                    BackgroundColor3 = Theme.PrimaryElementColor,
                    Size = UDim2.new(0,  410, 0.000, 25.900)
                }, {
                    Utility:Create('UICorner', {
                        CornerRadius = UDim.new(0, 5),
                    ...
                    Utility:Create('TextLabel', {
                        ...
                        BackgroundTransparency = 1,
                        Position = UDim2.new(0,  0, 0.000, 0.000),
                        Size = UDim2.new(0,  410, 0.000, 14.000),
                        Font = Enum.Font.Gotham,
                        Text = Title,
                        TextColor3 = Theme.PrimaryTextColor,
                        TextSize = 16,
                    ...
                    Utility:Create('TextLabel', {
                        ...
                        BackgroundColor3 = Theme.PrimaryElementColor,
                        BackgroundTransparency = 1,
                        Position = UDim2.new(0,  0, 0.000, 14.000),
                        Size = UDim2.new(0,  410, 0.000, 14.000),
                        Font = Enum.Font.Gotham,
                        Text = Paragraph,
                        TextColor3 = Theme.SecondaryTextColor,
                ...
                Utility:Create('Frame', {
                    ...
                    Utility:Create('TextButton', {
                        ...
                        Utility:Create('ImageLabel', {
                            ...
                            BackgroundColor3 = Theme.PrimaryElementColor,
                            BackgroundTransparency = 1,
                            Position = UDim2.new(0,  374, 0.000, 2.100),
                            Size = UDim2.new(0,  25, 0.000, 17.500),
            ...
            function Elements:CreateSlider(Name, MinimumValue, MaximumValue, DefaultValue, SliderColor, Callback)
                ...
                Utility:Create('Frame', {
                    ...
                    Parent = Section,
                    BackgroundColor3 = Theme.PrimaryElementColor,
                    Size = UDim2.new(0,  410, 0.000, 35.000)
                }, {
                    Utility:Create('UICorner', {
                        CornerRadius = UDim.new(0, 5),
                    ...
                    Utility:Create('TextButton', {
                        ...
                        BackgroundColor3 = Theme.SecondaryElementColor,
                        Position = UDim2.new(0,  7, 0.000, 20.300),
                        Size = UDim2.new(0,  395, 0.000, 7.000),
                        Text = '',
                        BorderSizePixel = 0,
                        AutoButtonColor = false
                    }, {
                        ...
                        Utility:Create('Frame', {
                            ...
                            Size = UDim2.new(0,  0, 0.000, 7.000),
                            BorderSizePixel = 0
                        }, {
                            Utility:Create('UICorner', {
                                CornerRadius = UDim.new(0, 5),
                    ...
                    Utility:Create('TextLabel', {
                        ...
                        BackgroundColor3 = Theme.PrimaryElementColor,
                        BackgroundTransparency = 1,
                        Position = UDim2.new(0,  299, 0.000, 0.000),
                        Size = UDim2.new(0,  110, 0.000, 21.000),
                        Font = Enum.Font.Gotham,
                        Text = '0',
                        TextColor3 = Theme.SecondaryTextColor,
                        TextSize = 14,
                ...
                SliderButton.MouseButton1Down:Connect(function()
                    ...
                    Utility:Tween(SliderTrail, {Size = UDim2.new(0,  math.clamp(Mouse.X - SliderTrail.AbsolutePosition.X, 0.000, 276.500), 0, 10)}, 0.25)
            ...
            function Elements:CreateTextbox(Name, Placeholder, Callback)
                ...
                Utility:Create('Frame', {
                    ...
                    Parent = Section,
                    BackgroundColor3 = Theme.PrimaryElementColor,
                    Size = UDim2.new(0,  410, 0.000, 28.000)
                }, {
                    Utility:Create('UICorner', {
                        CornerRadius = UDim.new(0, 5),
                    ...
                    Utility:Create('TextLabel', {
                        ...
                        BackgroundColor3 = Theme.PrimaryElementColor,
                        BackgroundTransparency = 1,
                        Position = UDim2.new(0,  0, 0.000, 3.500),
                        Size = UDim2.new(0,  299, 0.000, 21.000),
                        Font = Enum.Font.Gotham,
                        Text = Name,
                        TextColor3 = Theme.PrimaryTextColor,
                        TextSize = 16,
                    ...
                    Utility:Create('TextBox', {
                        ...
                        Position = UDim2.new(0,  400, 0.000, 14.000),
                        Size = UDim2.new(0,  50, 0.000, 17.500),
                        Font = Enum.Font.Gotham,
                ...
                if TextSize.X < 50 then 
                    Utility:Tween(Textbox, {Size = UDim2.new(0,  50, 0.000, 17.500)}, 0.25)
                else
                    Utility:Tween(Textbox, {Size = UDim2.new(0,  TextSize.X + 10, 0.000, 17.500)}, 0.25)
                end
            ...
            function Elements:CreateKeybind(Name, Key, Callback)
                ...
                Utility:Create('Frame', {
                    ...
                    Utility:Create('TextLabel', {
                        ...
                        BackgroundTransparency = 1,
                        Position = UDim2.new(0,  0, 0.000, 3.500),
                        Size = UDim2.new(0,  352, 0.000, 21.000),
                        Font = Enum.Font.Gotham,
                        Text = Name,
                        TextColor3 = Theme.PrimaryTextColor,
                        TextSize = 16,
                    ...
                    Utility:Create('TextButton', {
                        ...
                        Parent = KeybindHolder,
                        BackgroundColor3 = Theme.SecondaryElementColor,
                        Position = UDim2.new(0,  376, 0.000, 5.600),
                        Size = UDim2.new(0,  25, 0.000, 17.500),
                        Font = Enum.Font.Gotham,
                        Text = Current,
                        AnchorPoint = Vector2.new(1, 0.5),
                ...
                if TextSize.X < 25 then
                    Utility:Tween(Keybind, {Size = UDim2.new(0,  25, 0.000, 17.500)}, 0.25)
                else 
                    Utility:Tween(Keybind, {Size = UDim2.new(0,  TextSize.X + 10, 0.000, 17.500)}, 0.25)
                end
            ...
            function Elements:CreateToggle(Name, Default, ToggleColor, DebounceAmount, Callback)
                ...
                Utility:Create('Frame', {
                    ...
                    Utility:Create('TextLabel', {
                        ...
                        BackgroundTransparency = 1,
                        Position = UDim2.new(0,  0, 0.000, 3.500),
                        Size = UDim2.new(0,  344, 0.000, 21.000),
                        Font = Enum.Font.Gotham,
                        Text = Name,
                        TextColor3 = Theme.PrimaryTextColor,
                        TextSize = 16,
                    ...
                    Utility:Create('Frame', {
                        Name = Name..'Toggle',
                        BackgroundColor3 = Theme.SecondaryElementColor,
                        Position = UDim2.new(0,  352, 0.000, 5.600),
                        Size = UDim2.new(0,  50, 0.000, 17.500)        
                    }, {
                        Utility:Create('UIStroke', {
                        ...
                        Utility:Create('ImageLabel', {
                            ...
                            BackgroundColor3 = Theme.PrimaryElementColor,
                            BackgroundTransparency = 1,
                            Position = UDim2.new(0,  5, 0.000, 3.500),
                            Size = UDim2.new(0,  15, 0.000, 10.500),
                ...
                if Default then
                    ...
                    Utility:Tween(Toggle, {BackgroundColor3 = ToggleColor}, 0.25)
                    Utility:Tween(Circle, {Position = UDim2.new(0,  30, 0.000, 3.500)}, 0.25)
                end
                ...
                ToggleButton.MouseButton1Down:Connect(function()
                    if not Debounce then
                        ...
                        if Toggled then
                            ...
                            Utility:Tween(Circle, {Position = UDim2.new(0,  5, 0.000, 3.500)}, 0.25)
                        end
            ...
            function Elements:CreateDropdown(Name, List, Default, DebounceAmount, Callback)
                ...
                Utility:Create('Frame', {
                    ...
                    Utility:Create('TextLabel', {
                        ...
                        BackgroundTransparency = 1,
                        Position = UDim2.new(0,  0, 0.000, 3.500),
                        Size = UDim2.new(0,  200, 0.000, 21.000),
                        Font = Enum.Font.Gotham,
                        Text = Name,
                        TextColor3 = Theme.PrimaryTextColor,
                        TextSize = 16,
                    ...
                    Utility:Create('ImageLabel', {
                        ...
                        BackgroundTransparency = 1,
                        BorderSizePixel = 0,
                        Position = UDim2.new(0,  377, 0.000, 5.600),
                        Rotation = 270,
                        Size = UDim2.new(0,  25, 0.000, 17.500),
                    ...
                    Utility:Create('TextLabel', {
                        ...
                        BackgroundColor3 = Theme.PrimaryElementColor,
                        BackgroundTransparency = 1,
                        Position = UDim2.new(0,  199, 0.000, 5.600),
                        Size = UDim2.new(0,  176, 0.000, 17.500),
                        Font = Enum.Font.Gotham,
                        Text = SelectedItem,
                        TextColor3 = Theme.SecondaryTextColor,
                        TextSize = 14,
                    ...
                    Utility:Create('ScrollingFrame', {
                        ...
                        BackgroundColor3 = Theme.PrimaryElementColor,
                        BorderSizePixel = 0,
                        Position = UDim2.new(0,  0, 0.700, 0.000),
                        Size = UDim2.new(0,  410, 0.000, 21.000),
                        Visible = false,
                        ScrollBarImageColor3 = Theme.ScrollBarColor,
                        ScrollBarThickness = 3
                ...
                Utility:Create('Frame', {
                    ...
                    Visible = false,
                    BackgroundTransparency = 1,
                    Size = UDim2.new(0,  410, 0.000, 0.000)
                })
                ...
                DropdownButton.MouseButton1Click:Connect(function()
                    ...
                    if not Debounce then
                        if Opened then
                            Opened = false
                            Utility:Tween(DropdownFiller, {Size = UDim2.new(0,  410, 0.000, 0.000)}, 0.25)
                            Utility:Tween(DropList, {Size = UDim2.new(0,  410, 0.000, 0.000)}, 0.25)
                            ...
                            if #List <= 5 then
                                ...
                                Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize - UDim2.new(0,  0, 0.000, 105.000)}, 0.25)
                                Utility:Tween(Section, {Size = Section.Size - UDim2.new(0,  0, 0.000, 105.000)}, 0.25)
                            end
                            Debounce = true
                            task.wait(DebounceAmount)
                            Debounce = false
                            ...
                            if #List <= 5 then
                                ...
                                Utility:Tween(DropList, {Size = UDim2.new(0,  410, 0.000, 105.000)}, 0.25)
                                Utility:Tween(DropList, {CanvasSize = UDim2.new(0, 400, 0, DropListLayout.AbsoluteContentSize.Y)}, 0.25)
                                Utility:Tween(DropdownFiller, {Size = UDim2.new(0,  410, 0.000, 100.800)}, 0.25)
                                Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize + UDim2.new(0,  0, 0.000, 105.000)}, 0.25)
                                Utility:Tween(Section, {Size = Section.Size + UDim2.new(0,  0, 0.000, 105.000)}, 0.25)
                            end
                ...
                function DropdownFunctions:UpdateDropdown(NewList)
                    ...
                    if Opened then
                        ...
                        if #List <= 5 then
                            ...
                            Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize - UDim2.new(0,  0, 0.000, 63.000)}, 0.25)
                            Utility:Tween(Section, {Size = Section.Size - UDim2.new(0,  0, 0.000, 63.000)}, 0.25)
                        end
                        Debounce = true
                        task.wait(DebounceAmount)
                        Debounce = false
            ...
            function Elements:CreateColorpicker(Name, DefaultColor, DebounceAmount, Callback, ...)
                ...
                Utility:Create('Frame', {
                    ...
                    Utility:Create('Frame', {
                        ...
                        BackgroundColor3 = Theme.PrimaryElementColor,
                        BorderSizePixel = 0,
                        Position = UDim2.new(0,  0, 0.000, 28.000),
                        Size = UDim2.new(0,  410, 0.000, 79.800),
                        Visible = false
                    }, {
                        Utility:Create('UICorner', {
                            CornerRadius = UDim.new(0, 5),
                        ...
                        Utility:Create('ImageButton', {
                            Name = Name..'RGBPicker',
                            BackgroundColor3 = Theme.PrimaryElementColor,
                            Position = UDim2.new(0,  38, 0.000, 4.900),
                            Size = UDim2.new(0,  300, 0.000, 70.000),
                            ...
                            Utility:Create('ImageLabel', {
                                ...
                                BackgroundTransparency = 1,
                                Position = UDim2.new(0,  293, 0.000, -4.900),
                                Size = UDim2.new(0,  14, 0.000, 9.800),
                        ...
                        Utility:Create('ImageButton', {
                            ...
                            BackgroundColor3 = Theme.PrimaryElementColor,
                            Position = UDim2.new(0,  346, 0.000, 4.900),
                            Size = UDim2.new(0,  25, 0.000, 70.000),
                            ...
                            Utility:Create('ImageLabel', {
                                ...
                                BackgroundTransparency = 1,
                                AnchorPoint = Vector2.new(0.5, 0),
                                Position = UDim2.new(0.5,  0, 0.000, -4.200),
                                Size = UDim2.new(0,  14, 0.000, 9.800),
                                Image = 'rbxassetid://3926309567',
                                ImageColor3 = Color3.fromRGB(0, 0, 0),
                                ImageRectOffset = Vector2.new(628, 420),
                ...
                ColorpickerButton.MouseButton1Click:Connect(function()
                    if not Debounce then
                        if Opened then
                            Opened = false
                            Utility:Tween(ColorpickerFiller, {Size = UDim2.new(0,  410, 0.000, 0.000)}, 0.25)
                            Utility:Tween(RGBPicker, {Size = UDim2.new(0,  300, 0.000, 0.000)}, 0.25)
                            Utility:Tween(DarknessPicker, {Size = UDim2.new(0,  25, 0.000, 0.000)}, 0.25)
                            Utility:Tween(ColorpickerDropdown, {Size = UDim2.new(0,  410, 0.000, 0.000)}, 0.25)
                            Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize - UDim2.new(0,  0, 0.000, 79.800)}, 0.25)
                            Utility:Tween(Section, {Size = Section.Size - UDim2.new(0,  0, 0.000, 79.800)}, 0.25)
                            UpdateSectionSize()
                            Debounce = true
                            task.wait(DebounceAmount)
                            Debounce = false
                            ...
                            Utility:Tween(Tab, {CanvasSize = Tab.CanvasSize + UDim2.new(0,  0, 0.000, 79.800)}, 0.25)
                            Utility:Tween(Section, {Size = Section.Size + UDim2.new(0,  0, 0.000, 79.800)}, 0.25)
                            Utility:Tween(ColorpickerDropdown, {Size = UDim2.new(0,  410, 0.000, 79.800)}, 0.25)
                            Utility:Tween(RGBPicker, {Size = UDim2.new(0,  300, 0.000, 70.000)}, 0.25)
                            Utility:Tween(DarknessPicker, {Size = UDim2.new(0,  25, 0.000, 70.000)}, 0.25)
                            Utility:Tween(ColorpickerFiller, {Size = UDim2.new(0,  410, 0.000, 77.000)}, 0.25)
                            UpdateSectionSize()
                            Debounce = true
                            task.wait(DebounceAmount)
                            Debounce = false
            ...
            function Elements:CreateImage(Name, URL, ImageSize)
                ...
                local ImageSize = ImageSize or UDim2.new(0,  100, 0.000, 70.000)
                ...
                Button.MouseButton1Click:Connect(function()
                    if not Debounce then
                        if Opened then
                            Opened = false
                            Utility:Tween(ImageFiller, {Size = UDim2.new(0,  410, 0.000, 0.000)}, 0.25)
                            Utility:Tween(ImageDropdown, {Size = UDim2.new(0,  410, 0.000, 0.000)}, 0.25)
                            Utility:Tween(ImageIcon, {ImageColor3 = Theme.SecondaryTextColor}, 0.25)
                            ...
                            Utility:Tween(Image, {Size = UDim2.new(0,  410, 0.000, 0.000)}, 0.25)
                            UpdateImageCanvas()
                            UpdateSectionSize()
                            Debounce = true
                            task.wait(DebounceAmount)
