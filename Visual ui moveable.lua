	...
	function Gui:Tab(options)
				...
				do
					...
					table.insert(
						...
						UserInputService.InputBegan:Connect(function(input)
							if input.UserInputType == Enum.UserInputType.Touch and Button.Hover then
								Library:PlaySound(LibSettings.ClickSound)
								Library:Tween(Button["78"], {
									Length = 0.2,
				...
				do
					...
					table.insert(
						...
						UserInputService.InputBegan:Connect(function(key)
							if
								key.UserInputType == Enum.UserInputType.Touch
								and Slider.Hover
			...
			function Section:Dropdown(options)
				...
				do
					...
					table.insert(
						Dropdown.Connections,
						UserInputService.InputBegan:Connect(function(input)
							if input.UserInputType == Enum.UserInputType.Touch and Dropdown.Hover then
								Library:PlaySound(LibSettings.ClickSound)
								Library:Tween(Dropdown["4a"], {
									Length = 0.2,
									Goal = { Color = Color3.fromRGB(86, 86, 86) },
				...
				do
					...
					function Dropdown:AddItem(value)
						...
						table.insert(
							ConnectionBin,
							UserInputService.InputBegan:Connect(function(input)
								if input.UserInputType == Enum.UserInputType.Touch and DropdownOption.Hover then
									Library:PlaySound(LibSettings.ClickSound)
									Library:Tween(DropdownOption["50"], {
										Length = 0.2,
										Goal = { Color = Color3.fromRGB(86, 86, 86) },
				...
				do
					...
					table.insert(
						...
						Colorpicker["84"].InputBegan:Connect(function(input)
							if input.UserInputType == or Input.UserInputType == Enum.UserInputType.Touch then
								Library:PlaySound(LibSettings.ClickSound)
		...
		do
			...
			table.insert(
				ConnectionBin,
				UserInputService.InputBegan:Connect(function(input)
					if input.UserInputType == Enum.UserInputType.Touch and Tab.Hover then
						Library:PlaySound(LibSettings.ClickSound)
		...
		table.insert(
			...
			UserInputService.InputBegan:Connect(function(input)
				if Library.MainFrameHover then
					if input.UserInputType == Enum.UserInputType.Touch and not Library.Sliding then
						local ObjectPosition =
							Vector2.new(Mouse.X - Gui["2"].AbsolutePosition.X, Mouse.Y - Gui["2"].AbsolutePosition.Y)

						while
							RunService.RenderStepped:wait()
							and UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1,Enum.UserInputType.Touch)
						do
